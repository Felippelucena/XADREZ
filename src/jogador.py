...
class Jogador:
    ...
    def pegar_peça(self, posicao_pecas, historico, pecas):
        ...
        if row >= 0 and row < 8 and col >= 0 and col < 8:
            ...
            if posicao_pecas[row][col] != " " and posicao_pecas[row][col] in self.jogador_atual:
    ...
    def soltar_peça(self, posicao_pecas, historico, dados_historico,ultimo_movimento, menu_partida):
        self.mouse_pressed = False
        if self.origem_peca_selecionada != None:
            ...
            if row >= 0 and row < 9 and col >= 0 and col < 9 and (row, col) in self.movimentos:
                ...
                menu_partida.formatar_historico(dados_historico)
